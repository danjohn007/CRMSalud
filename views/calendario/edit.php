<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo $baseUrl; ?>calendario/show/<?php echo $id; ?>" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo $baseUrl; ?>calendario/update/<?php echo $id; ?>">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="<?php echo $baseUrl; ?>calendario/show/<?php echo $id; ?>" class="btn btn-secondary">
