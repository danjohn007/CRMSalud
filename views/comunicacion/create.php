    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Nueva Comunicación</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="<?php echo $baseUrl; ?>comunicacion/store">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-send"></i> Enviar Comunicación
                        </button>
                        <button type="submit" name="borrador" class="btn btn-outline-secondary">
                            <i class="bi bi-save"></i> Guardar como Borrador
                        </button>
                        <a href="<?php echo $baseUrl; ?>comunicacion" class="btn btn-secondary">
