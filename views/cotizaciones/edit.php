<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo $baseUrl; ?>cotizaciones/view/<?php echo $id; ?>" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo $baseUrl; ?>cotizaciones/update/<?php echo $id; ?>">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo $baseUrl; ?>cotizaciones/view/<?php echo $id; ?>" class="btn btn-secondary">
