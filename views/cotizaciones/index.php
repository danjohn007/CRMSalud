<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo $baseUrl; ?>cotizaciones/create" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-center p-4">
                    ...
                    <h4 class="mt-3 text-muted">Módulo de Cotizaciones</h4>
                    <p class="text-muted">
                        Este módulo está en construcción. Próximamente podrás gestionar todas las cotizaciones del sistema.
                    </p>
