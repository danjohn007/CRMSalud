    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Crear Nueva Campaña de Marketing</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="<?php echo $baseUrl; ?>marketing/store">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check"></i> Crear Campaña
                        </button>
                        <a href="<?php echo $baseUrl; ?>marketing" class="btn btn-secondary">
