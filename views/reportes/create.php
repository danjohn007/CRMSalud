    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Crear Nuevo Reporte</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="<?php echo $baseUrl; ?>reportes/store">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-play"></i> Generar Reporte
                        </button>
                        <button type="submit" name="programar" class="btn btn-outline-info">
                            <i class="bi bi-clock"></i> Programar Generación
                        </button>
                        <a href="<?php echo $baseUrl; ?>reportes" class="btn btn-secondary">
